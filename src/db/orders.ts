...
export default [
  {
    ...
    payment: 75,
    description:
      "A cozy starter home for new residents, providing basic shelter and comfort.",
  },
  {
    id: 2,
    ...
    payment: 150,
    description:
      "A modern educational facility to support learning and community development.",
  },
  {
    id: 3,
    name: "Water Plant",
    ...
    payment: 250,
    description:
      "A critical infrastructure project to ensure clean water supply for the community.",
  },
  {
    id: 4,
    name: "Art Gallery",
    ...
    payment: 120,
    description:
      "A cultural hub to showcase local art and foster creativity in the community.",
  },
  {
    id: 5,
    ...
    payment: 200,
    description:
      "A key electrical infrastructure to provide reliable power distribution.",
  },
  {
    id: 6,
    name: "Swimming Pool",
    ...
    payment: 120,
    description:
      "A recreational facility to promote fitness and provide a cool retreat for residents.",
  },
  {
    id: 7,
    name: "Hospital",
    ...
    payment: 250,
    description:
      "A critical healthcare facility to provide medical services and save lives.",
  },
  {
    id: 8,
    name: "Fire Station",
    ...
    payment: 150,
    description:
      "A vital emergency response center to protect lives and property from fires.",
  },
];
